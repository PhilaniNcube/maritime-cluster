    ...
    <nav className="">
      ...
      <div className="max-w-7xl mx-auto flex py-6 justify-between items-center px-4">
        ...
        <span
          ...
          className="hidden md:flex cursor-pointer justify-center items-center border-2 border-black rounded-full px-4 py-1"
        >
          <Mail />
...
const Menu = () => {
  return (
    <svg
      ...
      className="h-8 w-8 text-black border border-black rounded-full p-1 rotate-90"
      fill="none"
      viewBox="0 0 24 24"
      stroke="currentColor"
      strokeWidth={2}
