        ...
        <div className="max-w-7xl mx-auto flex flex-col justify-center min-h-[50vh] items-center  border-b border-black">
          <div className="grid grid-cols-5 mb-5">
            ...
            <div className="col-span-5 md:col-span-3 p-4 grid grid-cols-2 md:grid-cols-3 gap-4 ">
              <Link href="/team/faisal" passHref>
                <div className="w-full cursor-pointer">
                  <Image
                    ...
                    height={500}
                  />
                  <p className="cursor-pointer text-md text-gray-600">
          ...
          <div className="w-full my-8">
            ...
            <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-4 py-6">
              <div className=" rounded flex flex-col justify-center items-center h-36">
                <img src="/images/saimi.png" className="h-16 object-cover" />
              </div>
              <div className=" rounded flex flex-col justify-center items-center h-36">
                <img src="/images/chamber.png" className="h-16 object-cover" />
              </div>
              <div className=" rounded flex flex-col justify-center items-center h-36">
                <img src="/images/nmu.png" className="w-full object-cover" />
              </div>

              <div className=" rounded flex flex-col justify-center items-center h-36">
                <img src="/images/nmbm.png" className="h-16 object-cover" />{" "}
              </div>
              <div className=" rounded flex flex-col justify-center items-center h-36">
                <img
              ...
              <div className=" rounded flex flex-col justify-center items-center h-36">
                <img src="/images/rial.jpeg" className="w-3/4 object-cover" />
              </div>
              <div className=" rounded flex flex-col justify-center items-center h-36">
                <img src="/images/coega.png" className="w-2/5 object-cover" />{" "}
              </div>
            </div>
          </div>
        </div>
