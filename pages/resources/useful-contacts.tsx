          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="max-w-7xl mx-auto my-8 px-4">
              <div className="grid grid-cols-2 gap-8 md:grid-cols-3">
                <Link href="https://saimi.co.za/contact-us/">
                  <a className="bg-slate-200 w-full aspect-video rounded-lg hover:shadow flex justify-center items-center font-bold text-3xl text-gray-700">
                    SAIMI
                  </a>
                </Link>
                <Link href="https://www.transnetnationalportsauthority.net/ContactUs/Pages/Head-Office-Contact-Details.aspx">
                  <a className="bg-slate-200 w-full aspect-video rounded-lg hover:shadow flex justify-center items-center font-bold text-3xl text-gray-700">
                    Transnet
                  </a>
                </Link>
                <Link href="https://www.nmbbusinesschamber.co.za/contact-us">
                  <a className="bg-slate-200 text-center px-8 w-full aspect-video rounded-lg hover:shadow flex justify-center items-center font-bold text-3xl text-gray-700">
                    Nelson Mandela bay Business Chamber
                  </a>
                </Link>
                <Link href="https://rialfishing.co.za/contact.php">
                  <a className="bg-slate-200 text-center px-8 w-full aspect-video rounded-lg hover:shadow flex justify-center items-center font-bold text-3xl text-gray-700">
                    Rial Fishing
                  </a>
                </Link>
                <Link href="https://www.mandela.ac.za">
                  <a className="bg-slate-200 text-center px-8 w-full aspect-video rounded-lg hover:shadow flex justify-center items-center font-bold text-3xl text-gray-700">
                    Mandela Bay University
                  </a>
                </Link>
                <Link href="https://www.coega.co.za/Feedback.aspx?objID=117">
                  <a className="bg-slate-200 text-center px-8 w-full aspect-video rounded-lg hover:shadow flex justify-center items-center font-bold text-3xl text-gray-700">
                    Coega
                  </a>
                </Link>
